<?php include('partials/header.php'); ?>
                ...
                <div class="row">
                 <div class="col-mod-12">
                  ...
                  <ul class="breadcrumb">
                   ...
                   <li class="active">Live Charts</li>
                 </ul>
                ...
                <h3 class="page-header"><i class="fa fa-bar-chat-o"></i> Live Charts </h3>
              ...
              <div class="panel panel-cascade">
               <div class="panel-heading">
                <h3 class="panel-title">
                 ...
                 Morris Live Chart
                 <span class="pull-right" id="reloadStatus">0 Reloads</span>
               </h3>
             </div>
        ...
        <div class="panel panel-cascade">
         <div class="panel-heading">
          <h3 class="panel-title">
           ...
           NVD3 Live Chart
           <button class="btn btn-danger pull-right  btn-xs text-white" id='start-stop-button'>Stop Live Stream</button> 
         </h3>
       </div>
       <div class="panel-body">

        <div id='nvdLive' class='chart half with-transitions'>
         <svg></svg>
		...
		<div class="panel panel-cascade">
			<div class="panel-heading">
				<h3 class="panel-title">
					...
					Flot Live Chart
					<p class="pull-right">Time between updates: <input id="updateInterval" size="3"  type="text" value="" > milliseconds</p>
				</h3>
			</div>
			<div class="panel-body">
...
<script src="js/charts/live-charts-custom.js"></script>
