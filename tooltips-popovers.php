<?php include('partials/header.php'); ?>  
                ...
                <div class="row">
                 <div class="col-mod-12">
                  ...
                  <ul class="breadcrumb">
                   ...
                   <li class="active">Tooltips &amp; Popovers</li>
                 </ul>
                ...
                <h3 class="page-header"><i class="fa fa-asterisk"></i> Tooltips &amp; Popovers <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>

                <blockquote class="page-information hidden">
                 <p>
                  <b>Tooltips</b> are an updated version, which don't rely on images, use CSS3 for animations, and data-attributes for local title storage.<br><b>Popovers</b>Add small overlays of content, like those on the iPad, to any element for housing secondary information
                </p>
              </blockquote>
          ...
          <div class="panel-body panel-border tooltips">
           <div class="list-group">
            <a href="" data-original-title="Yeah I am here , you caught me nice!" data-placement="left" class="btn bg-primary text-white list-group-item">Tooltip on Left</a>
            <a href="" data-original-title="Yeah I am here , you caught me nice!" data-placement="right" class="btn bg-primary text-white list-group-item">Tooltip on Right</a>
            <a href="" data-original-title="Yeah I am here , you caught me nice!" data-placement="top" class="btn bg-primary text-white list-group-item">Tooltip on Top</a>
            <a href="" data-original-title="Yeah I am here , you caught me nice!" data-placement="Bottom" class="btn bg-primary text-white list-group-item">Tooltip on Bottom</a>
          </div>
        </div> <!-- /panel body -->	
      </div>	
    </div>
  ...
  <div class="panel-body panel-border popovers text-center">
