<?php include('partials/header.php'); ?>
                ...
                <h3 class="page-header"><i class="fa fa-google-plus"></i> Google Maps </h3>
       ...
       <div class="row">
         <div class="col-md-12">
          ...
          <div class="panel-body nopadding">
           <div id="map_clustering" class="map rounded"></div>
         </div> <!-- /panel body -->	
       </div>
     </div>
   </div>
   ...
   <div class="row">
     <div class="col-md-12">
      ...
      <div class="panel-body nopadding">
       <div id="map_html5" class="map rounded"></div>
     </div> <!-- /panel body -->	
   </div>
 </div>
</div>
...
<script type="text/javascript" src="js/googleMaps/demo.js"></script>
<script type="text/javascript" src="js/googleMaps/jquery.ui.map.js"></script>
<script type="text/javascript" src="js/googleMaps/markerclusterer.min.js"></script>
<script type="text/javascript" src="js/googleMaps/jquery.ui.map.services.js"></script>
<script type="text/javascript" src="js/googleMaps/jquery.ui.map.microformat.js"></script>

<script type="text/javascript" src="js/googleMaps/googleMaps-custom.js"></script>
