<?php include('partials/header.php'); ?>
                ...
                <h3 class="page-header"> Grids <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
            ...
            <div class="panel">
             <div class="panel-heading">
              <h3 class="panel-title text-primary">
               <i class="fa fa-th"></i> Grid Divisions
...
<div class="row">
	<div class="col-md-12">
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title text-primary">
					<i class="fa fa-th-large"></i> Panels In Grid
					<span class="pull-right">
						<a  href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
						<a  href="#"  class="panel-close"><i class="fa fa-times"></i></a>
					</span>
