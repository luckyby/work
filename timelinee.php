...
<!-- /header -->
<div class="row timelinee">
	
	<ul class="breadcrumb">
		<li><a href="index.php">Dashboard</a></li>
		<li><a href="#">timelinee</a></li>		
	</ul>
	...
	<h3 class="page-header">Timeline <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
				...
				<ul class="cbp_tmtimeline">
					<li>
						...
						<div class="cbp_tmlabel">
							<h2>Rick yoern</h2>
							<p>posted an update was watching <i class="fa fa-caret-square-o-right"></i> <a href="#">DIE HARD 2.0</a></p>
						</div>
					</li>
					<li>
						...
						<div class="cbp_tmlabel">
							<h2>Nelson John</h2>
							<p>New updates on cascade has been released please visit us for more details.. <a href="#"><i class="fa fa-info-circle"></i></a></p>
						</div>
					</li>					
					<li>
						...
						<div class="cbp_tmicon cbp_tmicon-phone"></div>
						<div class="cbp_tmlabel">
							<h2>henry richards</h2>
							<p>shared location at <a href="#"> <i class="fa fa-map-marker"></i></a> newyork,kpc</p>
						</div>
					</li>
					<li>
						...
						<div class="cbp_tmlabel">
							<h2>Shara joseph</h2>
							<p>posted image at <a href="#">chicago</a></p>
							<div class="post-lgimage">
								<img src="images/timeline/timeline4.jpg" alt="">								
							</div>
							<p>A new study conducted by Dove revealed about 63% of women believe social media is influencing today’s definition of beauty more than print media, film and music.</p>
							 <a href="#" class="btn btn-default btn-sm btn-animate-demo">share <i class="fa fa-eye"></i></a>
							 <a href="#" class="btn btn-success btn-sm btn-animate-demo">download <i class="fa fa-download"></i></a>
					...
					<li>
						...
						<div class="cbp_tmlabel">
							<h2>ruther daikon</h2>
							<p>Shared video with <a href="#">donald richards</a></p>
							<iframe src="//player.vimeo.com/video/50522981" width="100%" class="article-image" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <p><a href="http://vimeo.com/50522981"></a>
						</div>
					</li>
					<li>
						...
						<div class="cbp_tmlabel">
							<h2>yanome</h2>
							<p>posted pictures</p>							
								<div class="col-md-3 col-sm-3 col-xs-3 post-smimage"><img src="images/profiles/one.png" alt=""></div>
								<div class="col-md-3 col-sm-3 col-xs-3 post-smimage"><img src="images/profiles/one.png" alt=""></div>
								<div class="col-md-3 col-sm-3 col-xs-3 post-smimage"><img src="images/profiles/one.png" alt=""></div>
								<div class="col-md-3 col-sm-3 col-xs-3 post-smimage"><img src="images/profiles/one.png" alt=""></div>	
								&nbsp;																															
