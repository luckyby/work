<?php include('partials/header.php'); ?>  
                ...
                <h3 class="page-header"> Wells <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>

                <blockquote class="page-information hidden">
                 <p>
                  <b>Wells</b> adds a simple effect on an element to give it an inset effect.
                </p>
              </blockquote>
              <blockquote>
            ...
            <div class="panel panel-cascade">
             <div class="panel-heading">
              <h3 class="panel-title text-primary">
               <i class="fa fa-thumb-tack"></i> Basic Wells
               <span class="pull-right">
                <div class="btn-group code">
                 ...
                 <ul class="dropdown-menu pull-right list-group" role="menu">
                  <li class="list-group-item"><code>.well</code></li>
                  <li class="list-group-item"><code>.well-lg</code></li>
                  <li class="list-group-item"><code>.well-sm</code></li>
                </ul>
              </div>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-cascade">
			<div class="panel-heading">
				<h3 class="panel-title text-primary">
					<i class="fa fa-thumb-tack"></i> Other Wells
					<span class="pull-right">
						<div class="btn-group code">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
							<ul class="dropdown-menu pull-right list-group" role="menu">
			...
			<div class="panel-body panel-border">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="well bg-warning text-white">
							Many a small thing has been made large by the right kind of advertising.
						</div>
