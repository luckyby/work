<?php include('partials/header.php'); ?>
                ...
                <div class="row">
                 ...
                 <h3 class="page-header"><i class="fa fa-eye"></i> Pickers <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
             ...
             <div class="col-md-12">
              <form class="form-horizontal" role="form">
               <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Color picker Hexa Format</label>
                <div class="col-sm-8">
                 <input type="text" class="form-control form-cascade-control" value="" id="cp1" >
               </div>
             </div>
             <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">RGB Format</label>
              <div class="col-sm-8">
               <input type="text" class="form-control form-cascade-control" value="rgb(0,194,255,0.78)" id="cp2" data-color-format="rgba">
             </div>
           </div>
           <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Color picker RGB Format</label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Color picker HEX Format</label>
          <div class="col-sm-8">
           <div class="input-group colorpicker-component bscp" data-color="#54728c" data-color-format="hex" id="cp4">
            <input type="text" value="" readonly class="form-control" />
...
<h4 class="page-header"> Time Picker </h4>
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" role="form">
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-4 control-label">Default timepicker. Value = (12:00 PM)</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-4 control-label">Inside a modal with 24hr mode and seconds enabled.</label>
				<div class="col-sm-4">
					<div class="input-group bootstrap-timepicker">
