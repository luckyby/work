<?php include('partials/header.php'); ?>
                ...
                <div class="row">
                 ...
                 <h3 class="page-header"><i class="fa fa-warning"></i> Form Validation <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
          ...
          <div class="panel-body ">
            <div class="ro">
             ...
             <div class="form-group">
              ...
              <div class="col-lg-10 col-md-9">
               <input type="text" class="form-control form-cascade-control input-small" name="date" id="date">
             </div>
           </div>
           <div class="form-group">
            <label class="col-lg-2 col-md-3 control-label">Zip</label>
            <div class="col-lg-10 col-md-9">
             <input type="text" class="form-control form-cascade-control input-small" name="zip" id="zip">
           </div>
         </div>
         <div class="form-group">
       ...
       <div class="form-actions">
        <input type="submit" value="Validate" class="btn bg-primary text-white btn-lg">
      </div>
    </form>
  </div>
</div>
