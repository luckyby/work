<?php include('partials/header.php'); ?>
                ...
                <h3 class="page-header"><i class="fa fa-level-up"></i> Dropzone File Upload <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>

                <blockquote class="page-information hidden">
                 <p>
                  Easily <b>Drag &amp; Drop</b> items here for upload. Multiple items upload adds an extra feature!
                </p>
              </blockquote>
...
<script type="text/javascript" src="js/file-uploads-custom.js"></script>
