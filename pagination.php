<?php include('partials/header.php'); ?>
                ...
                <h3 class="page-header"><i class="fa fa-sort-numeric-asc"></i> Pagination <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
               ...
               <span class="pull-right">
                <div class="btn-group code">
                 ...
                 <ul class="dropdown-menu pull-right list-group" role="menu">
                  <li class="list-group-item"><code>.pagination</code></li>
                </ul>
              </div>
				...
				<h3 class="panel-title">
					...
					<span class="pull-right">
						<div class="btn-group code">
							...
							<ul class="dropdown-menu pull-right list-group" role="menu">
								<li class="list-group-item"><code>.pagination</code></li>
								<li class="list-group-item"><code>.disabled</code></li>
...
</div> <!-- /Disabled and Active States -->
				...
				<h3 class="panel-title">
					...
					<span class="pull-right">
						<div class="btn-group code">
							...
							<ul class="dropdown-menu pull-right list-group" role="menu">
								<li class="list-group-item"><code>.pagination</code></li>
								<li class="list-group-item"><code>.pagination-lg</code></li>
								<li class="list-group-item"><code>.pagination-sm</code></li>
							</ul>
						</div>
						<a  href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
						<a  href="#"  class="panel-close"><i class="fa fa-times"></i></a>
					...
					<h3 class="panel-title">
						...
						<span class="pull-right">
							<div class="btn-group code">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
								<ul class="dropdown-menu pull-right list-group" role="menu">
									<li class="list-group-item"><code>.pager</code></li>
								</ul>
							</div>
							<a  href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
							<a  href="#"  class="panel-close"><i class="fa fa-times"></i></a>
					...
					<h3 class="panel-title">
						...
						<span class="pull-right">
							<div class="btn-group code">
								...
								<ul class="dropdown-menu pull-right list-group" role="menu">
									<li class="list-group-item"><code>.pager</code></li>
									<li class="list-group-item"><code>.previous</code></li>
									<li class="list-group-item"><code>.next</code></li>
								</ul>
							</div>
							<a  href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
							<a  href="#"  class="panel-close"><i class="fa fa-times"></i></a>
