...
<head>
  <meta charset="utf-8">
  <title>Dashboard | Cascade Flat , Responsive Bootstrap 3.0 Admin Template</title>
...
<div class="box-holder">
 ...
 <div class="left-sidebar">
  <div class="sidebar-holder">
   ...
   <li><a href="index.php" data-original-title="Dashboard"><i class="fa fa-dashboard"></i><span class="hidden-minibar"> Dashboard </span></a></li>
   <li><a href="top-navbar.php" data-original-title="Top Navbar"><i class="fa fa-indent"></i><span class="hidden-minibar"> Top Navbar </span></a></li>
   ...
   <li class="submenu">
    ...
    <ul>
      <li><a href="calendar.php" data-original-title="Calendar"><i class="fa fa-calendar"></i><span class=""> Calendar</span></a></li>
      <li><a href="chat.php" data-original-title="Chat"><i class="fa fa-comment"></i><span class=""> Chat</span></a></li>
      <li><a href="profile.php" data-original-title="Profile Activity"><i class="fa fa-th"></i><span class=""> Profile Activity</span></a></li>
      
      <li><a href="gallery.php" data-original-title="Gallery"><i class="fa fa-th"></i><span class=""> Gallery</span></a></li>
      <li><a href="grids.php" data-original-title="Grids"><i class="fa fa-th-large"></i><span class=""> Grids</span></a></li>
      
      <li><a href="images.php" data-original-title="Images"><i class="fa fa-picture-o"></i><span class=""> Images</span></a></li>
      <li><a href="inbox.php" data-original-title="Inbox"><i class="fa fa-envelope"></i><span class=""> Inbox</span></a></li>
      <li><a href="invoice.php" data-original-title="Invoice"><i class="fa fa-credit-card"></i><span class=""> Invoice</span></a></li>
      <li><a href="pricing-table.php" data-original-title="Pricing Table"><i class="fa fa-money"></i><span class=""> Pricing Table</span></a></li>
      <li><a href="support.php" data-original-title="Support"><i class="fa fa-gears"></i><span class=""> Support</span></a></li>
      <li><a href="timeline.php" data-original-title="Timeline"><i class="fa fa-clock-o"></i><span class=""> Timeline</span></a></li>
      <li><a href="typography.php" data-original-title="Typography"><i class="fa fa-text-width"></i><span class=""> Typography</span></a></li>
    </ul>
  </li>
  ...
  <li class="submenu">
   ...
   <ul class="submenu-items">
    <li><a href="404.php" data-original-title="404"><i class="fa fa-exclamation-circle"></i><span class=""> 404 Error Page</span></a></li>
    <li><a href="505.php" data-original-title="505"><i class="fa fa-exclamation-circle"></i><span class=""> 505 Error Page</span></a></li>
    <li><a href="faq.php" data-original-title="FAQ"><i class="fa fa-question"></i><span class=""> FAQ</span></a></li>
    <li><a href="screens.php" data-original-title="Lock Screen"><i class="fa fa-lock"></i><span class=""> Lock Screen</span></a></li>
    <li><a href="screens.php" data-original-title="LogIn"><i class="fa fa-sign-in"></i><span class=""> Log In</span></a></li>
    <li><a href="screens.php" data-original-title="SignUp"><i class="fa fa-smile-o"></i><span class=""> Sign Up</span></a></li>
    <li><a href="template.php" data-original-title="Template"><i class="fa fa-pagelines"></i><span class=""> Template Page</span></a></li>
  </ul> 
</li>
...
<li class="submenu"> <!-- Example for second level menu -->
 ...
 <ul>
  <li><a href="alerts.php" data-original-title="Alerts"><i class="fa fa-exclamation-triangle"></i><span class=""> Alerts</span></a></li>
  <li><a href="animations.php" data-original-title="Animations"><i class="fa fa-font"></i><span class=""> Animations</span></a></li>
  <li><a href="breadcrumbs-jumbotron.php" data-original-title="Breadcrumbs"><i class="fa fa-chain"></i><span class=""> Breadcrumbs &amp; Jumbo</span></a></li>
  <li><a href="buttons.php" data-original-title="Buttons"><i class="fa fa-sort"></i><span class=""> Buttons </span></a></li>
  <li><a href="carousel.php" data-original-title="carousel"><i class="fa fa-coffee"></i><span class=""> Carousel</span></a></li>
  <li><a href="notifications.php" data-original-title="Notifications"><i class="fa fa-bell-o"></i><span class=""> Notifications</span></a></li>
  <li><a href="knobs.php" data-original-title="Knobs"><i class="fa fa-dot-circle-o"></i><span class=""> Knobs</span></a></li>
  <li><a href="labels-badges.php" data-original-title="Labels"><i class="fa fa-phone-square"></i><span class=""> Labels &amp; badges</span></a></li>
  <li><a href="list-groups.php" data-original-title="List Groups"><i class="fa fa-list"></i><span class=""> List Groups</span></a></li>
  <li><a href="pagination.php" data-original-title="Pagination"><i class="fa fa-sort-numeric-asc"></i><span class=""> Pagination</span></a></li>
  <li><a href="panels.php" data-original-title="Panels"><i class="fa fa-windows"></i><span class=""> Panels</span></a></li>
  <li><a href="progress-bars.php" data-original-title="Progress"><i class="fa fa-ruble"></i><span class=""> Progress Bars</span></a></li>
  <li><a href="sliders.php" data-original-title="Sliders"><i class="fa fa-exchange"></i><span class=""> Sliders</span></a></li>
  <li><a href="tabs-accordians.php" data-original-title="Tabs"><i class="fa fa-check"></i><span class=""> Tabs &amp; Accordians</span></a></li>
  <li><a href="info-boxes.php" data-original-title="Info Boxes"><i class="fa fa-bullseye"></i><span class=""> Info Boxes</span></a></li>
  <li><a href="tooltips-popovers.php" data-original-title="Tooltips"><i class="fa fa-asterisk"></i><span class=""> Tooltips &amp; popovers</span></a></li>
  <li><a href="wells.php" data-original-title="Wells"><i class="fa fa-beer"></i><span class=""> Wells</span></a></li>
</ul>
</li>    
...
<li class="submenu"> <!-- Example for second level menu -->
 ...
 <ul>
  <li><a href="basic-tables.php" data-original-title="Basic"><i class="fa fa-table"></i><span class="">  Basic Tables</span></a></li>
  <li><a href="editable-tables.php" data-original-title="Editable"><i class="fa fa-table"></i><span class="">  Editable Tables</span></a></li>
  <li><a href="dynamic-tables.php" data-original-title="Dynamic"><i class="fa fa-table"></i><span class="">  Dynamic Tables</span></a></li>
</ul> 
</li>
...
<li class="submenu"> <!-- Example for Third level menu -->
 ...
 <ul>
  <li><a href="#" data-original-title="SubMenu"><i class="fa fa-android"></i><span class=""> Submenu </span></a></li>
  <li><a href="#" data-original-title="SubMenu"><i class="fa fa-apple"></i><span class=""> Submenu </span></a></li>
  <li class="submenu">
   <a class="dropdown" href="#" data-original-title="One More"><i class="fa fa-windows"></i><span class=""> One More <span class="badge bg-primary pull-right">3</span></a>
   <ul>
    <li><a href="#" data-original-title="SubMenu"><i class="fa fa-facebook-square"></i><span class=""> Submenu </span></a></li>
    <li><a href="#" data-original-title="SubMenu"><i class="fa fa-google-plus-square"></i><span class=""> Submenu </span></a></li>
    <li class="submenu">
     <a class="dropdown" href="#" data-original-title="More Here"><i class="fa fa-twitter-square"></i><span class=""> More here <span class="badge bg-primary pull-right">3</span></a>
     <ul>
      <li><a href="#" data-original-title="SubMenu"><i class="fa fa-flickr"></i><span class=""> Submenu </span></a></li>
      <li><a href="#" data-original-title="SubMenu"><i class="fa fa-pinterest"></i><span class=""> Submenu </span></a></li>
      <li><a href="#" data-original-title="Add More"><i class="fa fa-linkedin-square"></i><span class="">More.. trust me </span></a></li>
    </ul> 
  </li>
</ul> 
</li>
...
<li class="submenu">
 ...
 <ul>
  <li ><a href="dropzone-file-upload.php" data-original-title="Dropzone"><i class="fa fa-level-down"></i><span class="">  Dropzone File Upload</span></a></li>
  <li><a href="form-input-masks.php" data-original-title="Input Masks"><i class="fa fa-pencil-square"></i><span class=""> Form Input Masks</span></a></li>
  <li><a href="form-validation.php" data-original-title="validation"><i class="fa fa-warning"></i><span class=""> Form Validation</span></a></li>
  <li><a href="form-wizard.php" data-original-title="Form wizard"><i class="fa fa-indent"></i><span class="">  Form Wizard</span></a></li>
  <li><a href="input-groups.php" data-original-title="Input Groups"><i class="fa fa-group"></i><span class=""> Input Groups</span></a></li>
  <li><a href="layouts-elements.php" data-original-title="Form Elements"><i class="fa fa-indent"></i><span class="">  Layouts &amp; elements</span></a></li>
  <li><a href="multiple-file-upload.php" data-original-title="File Upload"><i class="fa fa-cloud-upload"></i><span class="">  Multiple File Upload</span></a></li>
  <li><a href="pickers.php" data-original-title="Pickers"><i class="fa fa-eye"></i><span class="">  Pickers</span></a></li>
  <li><a href="wysiwyg-markdown.php" data-original-title="Wysiwyg &amp; Markdown"><i class="fa fa-pencil-square"></i><span class=""> Wysiwyg &amp; Markdown</span></a></li>
</ul> 
</li>
...
<li class="submenu">
 ...
 <ul>
  <li ><a href="basic-charts.php" data-original-title="Basic Charts"><i class="fa fa-bar-chart-o"></i><span class="">  Basic Charts</span></a></li>
  <li><a href="live-charts.php" data-original-title="Live Charts"><i class="fa fa-bar-chart-o"></i><span class=""> Live Charts</span></a></li>
  <li><a href="morris.php" data-original-title="Morris Charts"><i class="fa fa-bar-chart-o"></i><span class=""> Morris Charts</span></a></li>
  <li><a href="pie-charts.php" data-original-title="Pie Charts"><i class="fa fa-bar-chart-o"></i><span class="">  Pie Charts</span></a></li>
  <li><a href="sparklines.php" data-original-title="Spark Lines"><i class="fa fa-bar-chart-o"></i><span class="">  Spark Lines</span></a></li>
  <li><a href="nvd3.php" data-original-title="NVD3"><i class="fa fa-bar-chart-o"></i><span class="">  NVD3</span></a></li>
</ul> 
</li>
...
<li class="submenu">
 ...
 <ul>
  <li><a href="google-maps.php" data-original-title="Google Maps"><i class="fa fa-google-plus"></i><span class=""> Google Maps</span></a></li>
  <li><a href="vector-maps.php" data-original-title="Vector Maps"><i class="fa fa-vimeo-square"></i><span class=""> Vector Maps</span></a></li>
</ul> 
</li>
