<?php include('partials/header.php'); ?>
                ...
                <h3 class="page-header"><i class="fa fa-group"></i> Input Groups <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>

                <blockquote class="page-information hidden">
                 <p>
                  <b>Input Groups</b> extend form controls by adding text or buttons before, after, or on both sides of any text-based input.
                </p>
              </blockquote>
           ...
           <div class="col-md-6">
            <div class="panel panel-cascade">
             <div class="panel-heading">
              <h3 class="panel-title">Basic Input Groups
               <span class="pull-right">
                <div class="btn-group code">
                 ...
                 <ul class="dropdown-menu pull-right list-group" role="menu">
                  <li class="list-group-item"><code>.input-group</code></li>
 ...
 <div class="col-md-6">
  <div class="panel panel-cascade">
   <div class="panel-heading">
    <h3 class="panel-title">Sizing
     <span class="pull-right">
      <div class="btn-group code">
       <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
       <ul class="dropdown-menu pull-right list-group" role="menu">
        <li class="list-group-item"><code>.input-group-lg</code></li>
        <li class="list-group-item"><code>.input-group-sm</code></li>
        <li class="list-group-item"><code>.input-group-xs</code></li>
      </ul>
    </div>
    <a href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
    <a href="#" class="panel-close"><i class="fa fa-times"></i></a>
...
<div class="panel-body">
  <div class="row buttons-demo">
   <div class="col-md-12">
    <a class="input-group  demo-input-group input-group-lg">
     <span class="input-group-addon">@</span>
     <input type="text" class="form-control" placeholder="Username">
   </a>
   <a class="input-group  demo-input-group input-group-sm">
     <input type="text" class="form-control">
     <span class="input-group-addon">.00</span>
   </a>
   <a class="input-group  demo-input-group input-group-xs">
     <span class="input-group-addon">$</span>
     <input type="text" class="form-control">
     <span class="input-group-addon">.00</span>
   </a>
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-cascade">
			<div class="panel-heading">
				<h3 class="panel-title">Checkbox &amp; Radio Addons
					<span class="pull-right">
						<div class="btn-group code">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
							<ul class="dropdown-menu pull-right list-group" role="menu">
	...
	<div class="col-md-6">
		<div class="panel panel-demo">
			<div class="panel-heading">
				<h3 class="panel-title">Button Addons
					<span class="pull-right">
						<div class="btn-group code">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
							<ul class="dropdown-menu pull-right list-group" role="menu">
								<li class="list-group-item"><code>.input-group</code></li>
								<li class="list-group-item"><code>.input-group-btn</code></li>
							</ul>
						</div>
						<a href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
						<a href="#" class="panel-close"><i class="fa fa-times"></i></a>
...
<div class="row">
 <div class="col-md-12">
  <div class="panel panel-demo">
   <div class="panel-heading">
    <h3 class="panel-title">Buttons With Dropdowns
     <span class="pull-right">
      <div class="btn-group code">
       <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
       <ul class="dropdown-menu pull-right list-group" role="menu">
        <li class="list-group-item"><code>.input-group</code></li>
        <li class="list-group-item"><code>.input-group-btn</code></li>
        <li class="list-group-item"><code>.dropdown-toggle</code></li>
      </ul>
    </div>
    <a href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
    <a href="#" class="panel-close"><i class="fa fa-times"></i></a>
...
<div class="panel-body">
  <div class="row buttons-demo">
   <div class="col-md-6">
    <div class="input-group demo-input-group">
     <div class="input-group-btn">
      <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">LogIn <span class="caret"></span></button>
...
<div class="col-md-6">
  <div class="input-group demo-input-group">
   <input type="text" class="form-control">
   <div class="input-group-btn">
    <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">LogOut <span class="caret"></span></button>
...
<div class="row">
 <div class="col-md-12">
  <div class="panel panel-demo">
   <div class="panel-heading">
    <h3 class="panel-title">Segmented Buttons
     <span class="pull-right">
      <div class="btn-group code">
       <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
       <ul class="dropdown-menu pull-right list-group" role="menu">
        ...
        <li class="list-group-item"><code>.input-group-btn</code></li>
        <li class="list-group-item"><code>.dropdown-toggle</code></li>
        <li class="list-group-item"><code>.caret</code></li>
      </ul>
    </div>
    <a href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
    <a href="#" class="panel-close"><i class="fa fa-times"></i></a>
