...
<div class="row">
	<div class="col-mod-12">
		...
		<h3 class="page-header">Bootbox modals<i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
	...
	<div class="col-md-6 col-md-offset-3">
		<div class="panel panel-cascade">
			...
			<div class="panel-body panel-border">
				...
				<ul class="list-group">
					<li class="list-group-item">Alert<a href="#" data-bb="alert_callback" class="btn btn-info pull-right btn-xs">Show Model</a></li>
					<li class="list-group-item">Confirm <a href="#" data-bb="confirm" class="btn btn-info pull-right btn-xs">Show Model</a></li>
					<li class="list-group-item">Prompt <a href="#" data-bb="prompt" class="btn btn-info pull-right btn-xs">Show Model</a></li>
					<li class="list-group-item">Custom Dialog <a href="#" data-bb="dialog" class="btn btn-info pull-right btn-xs">Show Model</a></li>
				</ul>
...
<div class="bb-alert alert alert-info" style="display:none;">
	<span class="callBack">The examples populate this alert with dummy content</span>
</div>
<!-- .right-sidebar -->
...
<script src="js/bootbox-custom.js"></script>
