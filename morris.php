<?php include('partials/header.php'); ?>
                ...
                <h3 class="page-header"><i class="fa fa-bar-chart-o"></i> Morris Charts </h3>
...
<script src="js/charts/morris-0.4.3.min.js"></script>
<script src="js/charts/morris-custom.js"></script>
