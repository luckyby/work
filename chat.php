<?php include('partials/header.php'); ?>
  						<div class="row">
  							<div class="col-mod-12">
  								...
  								<h3 class="page-header"><i class="fa fa-comment"></i> Chat <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>

  								<blockquote class="page-information hidden">
  									<p>
  										This is the working chat page where you can talk to your clients ,provide support to them and meet their requirements with this great user interface.
  									</p>
  								</blockquote>
  								...
  								<div class="panel panel-cascade contacts-box">
  									...
  									<div class="panel-body nopadding">
  										<div class="list-group contact">
  											...
  											<a class="list-group-item">
  												<img src="images/profiles/thirteen.png" class="chat-user-avatar" alt="">
  												Ajith
  												<i class="fa fa-circle"></i>
  											</a>
  											<a class="list-group-item contact">
  												<img src="images/profiles/fourteen.png" class="chat-user-avatar" alt="">
  												Sindhu
  												<i class="fa fa-circle"></i>
  											</a>
  											<a class="list-group-item contact">
  												<img src="images/profiles/fifteen.png" class="chat-user-avatar" alt="">
  												Kishore
  												<i class="fa fa-circle busy"></i>
  											</a>
  										</div>
