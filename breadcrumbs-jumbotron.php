<?php include('partials/header.php'); ?>
                ...
                <div class="row">
                 <div class="col-mod-12">
                  ...
                  <ul class="breadcrumb">
                   ...
                   <li class="active">BreadCrumbs &amp; Jumbotron</li>
                 </ul>
                ...
                <h3 class="page-header"> Breadcrumbs &amp; Jumbotron <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>

                <blockquote class="page-information hidden">
                 <p>
                  <b>BreadCrumbs</b> indicate the current page's location within a navigational hierarchy.<br><b>Jumbotron</b> is a lightweight, flexible component that can optionally extend the entire viewport to showcase key content on your site.
                </p>
              </blockquote>
            ...
            <div class="panel panel-cascade">
             <div class="panel-heading">
              <h3 class="panel-title">
               <i class="fa fa-chain"></i> Breadcrumbs
               <span class="pull-right">
                <div class="btn-group code">
                 ...
                 <ul class="dropdown-menu pull-right list-group" role="menu">
                  <li class="list-group-item"><code>.breadcrumb</code></li>
                </ul>
              </div>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-cascade">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-magic"></i> Jumbotron
					<span class="pull-right">
						<div class="btn-group code">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Classes used"><i class="fa fa-code"></i></a>
							<ul class="dropdown-menu pull-right list-group" role="menu">
								<li class="list-group-item"><code>.jumbotron</code></li>
							</ul>
						</div>
						<a href="#" class="panel-minimize"><i class="fa fa-chevron-up"></i></a>
						<a href="#" class="panel-close"><i class="fa fa-times"></i></a>
