<?php include('partials/header.php'); ?>
                ...
                <div class="row">
                 <div class="col-mod-12">
                  ...
                  <ul class="breadcrumb">
                   ...
                   <li class="active">Basic Charts</li>
                 </ul>
                ...
                <h3 class="page-header"><i class="fa fa-bar-chart-o"></i> Basic Charts </h3>
            ...
            <div class="panel-body">
              <div id="flotOne" class="demo-placeholder"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="panel-body">
        <div id="flotTwo" class="demo-placeholder"></div>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-cascade">
			...
			<div class="panel-body">
				<div id="flotThree" class="demo-placeholder"></div>
			</div>
	...
	<div class="col-md-6">
		<div class="panel panel-cascade">
			...
			<div class="panel-body">
				...
				<p>
					<a class="btn btn-info" id="clearSelection">Clear selection</a>
					<a class="btn btn-primary" id="setSelection">Select year 1994</a>
				</p>
...
<script src="js/charts/flot-custom.js"></script>
