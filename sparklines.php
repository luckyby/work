<?php include('partials/header.php'); ?>  
                <div class="row">
                 ...
                 <h3 class="page-header"><i class="fa fa-pencil-square"></i> Sparklines </h3>
      ...
      <div class="row">
        ...
        <div class="panel-body ">
          <span class="mini-graph success-size "></span>
          <span class="mini-graph info-size "></span>
          <span class="mini-graph danger-size "></span>
          <span class="mini-graph pie-size "></span>
        </div>
      </div>	
    </div>
  </div>
...
<script src="js/charts/sparkline-custom.js"></script>	
