          ...
          <ul class="nav navbar-nav top-navbar ">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-chevron-circle-down"></i></a>
                <ul class="dropdown-menu">
                  <li><a href="calendar.php" ><i class="fa fa-calendar"></i> Calendar</a></li>
                        <li><a href="chat.php" ><i class="fa fa-comment"></i> Chat</a></li>
                        <li><a href="gallery.php"> <i class="fa fa-th"></i> Gallery</a></li>
                        <li><a href="grids.php"> <i class="fa fa-th-large"></i> Grids</a></li>
                        <li><a href="helpers.php"> <i class="fa fa-shield"></i> Helpers</a></li>
                        <li><a href="images.php"> <i class="fa fa-picture-o"></i> Images</a></li>
                        <li><a href="inbox.php"> <i class="fa fa-envelope"></i> Inbox</a></li>
                        <li><a href="invoice.php"> <i class="fa fa-credit-card"></i> Invoice</a></li>
                        <li><a href="pricing-table.php"><i class="fa fa-money"></i> Pricing Table</a></li>
                        <li><a href="support.php"><i class="fa fa-gears"></i> Support</a></li>
                        <li><a href="timeline.php"><i class="fa fa-clock-o"></i> Timeline</a></li>
            ...
            <li class="dropdown ">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Utility <i class="fa fa-chevron-circle-down"></i></a>
                <ul class="dropdown-menu">
                  <li><a href="coming-soon.php" data-original-title="Comming Soon"><i class="fa fa-flash"></i><span class="hidden-minibar"> Coming Soon</span></a></li>
                        ...
                        <li><a href="402.php" data-original-title="402"><i class="fa fa-exclamation-circle"></i><span class="hidden-minibar"> 402 Error Page</span></a></li>
                        ...
                        <li><a href="lock-screen.php" data-original-title="Lock Screen"><i class="fa fa-lock"></i><span class="hidden-minibar"> Lock Screen</span></a></li>
                        <li><a href="login.php" data-original-title="LogIn"><i class="fa fa-sign-in"></i><span class="hidden-minibar"> Log In</span></a></li>
                        <li><a href="signup.php" data-original-title="SignUp"><i class="fa fa-smile-o"></i><span class="hidden-minibar"> Sign Up</span></a></li>
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">UI Elements <i class="fa fa-chevron-circle-down"></i></a>
                <ul class="dropdown-menu">
                     <li><a href="alerts.php" data-original-title="Alerts"><i class="fa fa-exclamation-triangle"></i><span class="hidden-minibar"> Alerts</span></a></li>
                        ...
                        <li><a href="scrollspy.php" data-original-title="ScrollSpy"><i class="fa fa-star"></i><span class="hidden-minibar"> ScrollSpy</span></a></li>
				...
				<div class="panel-heading">
					<h3 class="panel-title">
						...
						<ul id="myTab" class="nav nav-tabs pull-right">
							...
							<li class="active"><a href="#profile" data-toggle="tab">Projects</a></li>
							<li class="dropdown">
